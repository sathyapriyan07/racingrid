...
-- If the table already existed (older deploy), ensure new columns are added.
alter table if exists races add column if not exists fp1_date date;
alter table if exists races add column if not exists fp1_time text;
alter table if exists races add column if not exists fp2_date date;
alter table if exists races add column if not exists fp2_time text;
alter table if exists races add column if not exists fp3_date date;
alter table if exists races add column if not exists fp3_time text;
